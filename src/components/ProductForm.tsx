...
const ProductForm = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-blue-900 p-4 rounded-lg">
      <div className="mb-4">
      ...
      <div className="mb-4">
        <label className="block text-blue-100">Category</label>
        <input
          type="text"
          name="category"
      ...
      <div className="mb-4">
        <label className="block text-blue-100">Price</label>
        <input
          type="number"
          name="price"
          value={product.price}
      ...
      <div className="mb-4">
        <label className="block text-blue-100">Description</label>
        <input
          type="text"
          name="description"
      ...
      <div className="mb-4">
        <label className="block text-blue-100">In Stock</label>
        <input
          type="checkbox"
          name="inStock"
